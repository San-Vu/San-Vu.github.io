#### Technical Skills: Python, C, C++, Java, Circuit Analysis and Design, Signal Processing, Soldering, Arduino, KiCad, Linux, MATLAB, Simulink, Altium Designer, Pytorch
...
### Bachelors in Electrical Engineering and Computer Science (EECS) GPA: 3.56/4.0
...
control, SMD soldering, oscilloscope, and multimeter usage


## Experience

**UAVS@Berkeley (_September 2023 - Present_)**
-  Designed and engineered components for UAVs@Berkeley’s 2024 SUAS competition hexacopter, including motor mounts, electrical battery management, and power distribution systems

**PolyPedal Lab Undergraduate Researcher (_January 2023 -- May 2023_)**
- Used a multitude of cameras and markers to collect positional data on lizard limb position and movement.
- Fine-tuned 3D model of gecko joint estimations using Deeplabcut to better approximate lizard righting movement.
- Conducted data refitting, revised model architecture to increase model fit accuracy
